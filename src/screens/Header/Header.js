...
const Header = () => {
	const { club, gender, setGender } = useContext(AppContext);
	useEffect(() => {
		applyTheme(club);
	}, [club]);
	...
	return (
		<div className='flex flex-col card'>
			<ul className='flex flex-col'>
				<li className='header__li' onClick={handleClickAll}>
					<a href='#all'>ALL</a>
				</li>
				<li className='header__li' onClick={handleClickMen}>
					<a href='#all'>MENS</a>
				</li>
				<li className='header__li' onClick={handleClickWomens}>
					<a href='#all'>WOMENS</a>
				</li>
			</ul>
